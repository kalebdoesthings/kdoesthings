...
name.replace(/[\[\]]/g,"\\$&")+"(=([^&#]*)|&|#|$)").exec(window.location.href);if(!results){return null};if(!results[2]){return''};return decodeURIComponent(results[2].replace(/\+/g," "));}
ZType=ig.Game.extend({font:new ig.Font('media/fonts/avenir-18-white.png'),fontTitle:new ig.Font('media/fonts/avenir-36-blue.png'),separatorBar:new ig.Image('media/ui/bar-blue.png'),idleTimer:null,spawnTimer:null,targets:{},currentTarget:null,yScroll:0,yScroll2:0,gradient:new ig.Image('media/background/gradient.png'),stars:new ig.Image('media/background/stars.jpg'),grid:new ig.Image('media/background/grid.png'),music1:new ig.Sound('media/music/endure.ogg',false),music2:new ig.Sound('media/music/orientation.ogg',false),cancelSound:new ig.Sound('media/sounds/cancel.ogg'),spawnSound:new ig.Sound('media/sounds/spawn.ogg'),menu:null,mode:0,score:0,streak:0,hits:0,misses:0,multiplier:1,wave:{},gameTime:0,kills:0,emps:0,personalBest:0,isPersonalBest:false,waitingForItunes:false,adPage:null,difficulty:(ig.ua.mobile?'MOBILE':'DESKTOP'),keyboard:null,textIsCaseSensitive:!!document.location.hash.match('cs'),textHasPunctuations:false,textHasNumbers:false,_screenShake:0,wordlist:null,init:function(){var flags=parseInt(ig.queryParam('flags'))||window.ZTYPE_FLAGS;if(flags&ZType.FLAG.CASE_SENSITIVE){this.textIsCaseSensitive=true;}
